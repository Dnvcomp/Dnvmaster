...
class MenusRepository extends Repository
{
    ...
    public function addMenu($request)
    {
        ...
        switch($data['type']) {
           ...
           case 'blogLink' :
                if($request->input('category_alias')) {
                    ...
                    $data['path'] = route('artisles.show',['alias'=>$request->input('article_alias')]);
                }
                break;
        ...
        if($this->model->fill($data)->save()) {
            return ['status'=>'Новая ссылка меню успешно добавлена'];
        }
    }
    ...
    public function updateMenu($request, $menu)
    {
        ...
        if($menu->fill($data)->update()) {
            return ['status'=>'Ссылка меню успешно обновлена'];
        }
    }
    ...
    public function deleteMenu($menu)
    {
        ...
        if($menu->delete()) {
            return ['status'=>'Ссылка меню удалена'];
        }
    }
